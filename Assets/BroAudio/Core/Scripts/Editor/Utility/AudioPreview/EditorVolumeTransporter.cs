...
namespace Ami.BroAudio.Editor
{
    public class EditorVolumeTransporter : EditorUpdateHelper
    {
        ...
        private PreviewData _clipData = null;
        ...
        public void SetData(PreviewData clipData)
        {
            _clipData = clipData;
        ...
        private float GetStartVolume(PreviewData clipData)
        {
            return clipData.FadeIn > 0f ? 0f : clipData.Volume; ;
        }

        public bool IsNewVolumeDifferentFromCurrent(PreviewData clipData)
        {
            float startVol = GetStartVolume(clipData);
